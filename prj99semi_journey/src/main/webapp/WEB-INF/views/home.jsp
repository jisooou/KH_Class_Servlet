...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	...
	<head>
	    ...
	    <link rel="stylesheet" href="http://127.0.0.1:8888/journey/resources/css/home.css">
	    ...
	    <nav>
	        <div class="search">
	            <button class="search-item" onclick="showPlaceSearch()">
	                <span>여행지</span>
	                <span id="search-destination">여행지 검색</span>
	            </button>
	            ...
	            <button type="submit" class="search-icon">
	                <img src="./resources/image/search.png" alt="검색 아이콘">
	            </button>
	
	            <div class="search-place" id="search-place">
	                <h5 class="search-place-letter">지역으로 검색하기</h5>
	                <button class="search-place-button">
	                    <img src="./resources/image/place-search.png" alt="유연한 검색">
	                    <span>유연한 검색</span>
	                </button>
	                <br>
	                <h5 class="search-place-letter">한국</h5><br>
	        ...
	        <div class="traveler" id="traveler">
	          <div class="traveler-option">
	            <span>성인</span>
	            <span class="age-info">13세 이상</span>
	          ...
	          <div class="traveler-option">
	            <span>어린이</span>
	            <span class="age-info">2~12세</span>
	            <div class="people-count">
	              <button class="decrease">-</button>
	              <span class="count">0</span>
	              <button class="increase">+</button>
	          ...
	          <div class="traveler-option">
	            <span>유아</span>
	            <span class="age-info">2세 미만</span>
	            <div class="people-count">
	              <button class="decrease">-</button>
	              <span class="count">0</span>
	              <button class="increase">+</button>
	    ...
	    <section>
	      <div class="theme">
	        <button id="theme-detail">
	          <img src="./resources/image/sea.svg" alt="테마">
	          <span id="theme-name">해변 바로 앞</span>
	        </button>
	        <button id="theme-detail">
	          <img src="./resources/image/hanok.svg" alt="테마">
	          <span id="theme-name">한옥</span>
	        </button>
	        <button id="theme-detail">
	          <img src="./resources/image/view.svg" alt="테마">
	          <span id="theme-name">최고의 전망</span>
	        </button>
	        <button id="theme-detail">
	          <img src="./resources/image/pool.svg" alt="테마">
	          <span id="theme-name">멋진 수영장</span>
	        </button>
	        <button id="theme-detail">
	          <img src="./resources/image/camping.svg" alt="테마">
	          <span id="theme-name">캠핑장</span>
	        </button>
	        <button id="theme-detail">
	          <img src="./resources/image/wierd.svg" alt="테마">
	          <span id="theme-name">기상천외한</span>
	        </button>
	        <button id="theme-detail">
            <img src="/image/world.png" alt="테마">
            <span id="theme-name">속세를 벗어난</span>
	        </button>
	        <button id="theme-detail">
	          <img src="./resources/image/top.svg" alt="테마">
	          <span id="theme-name">세상의 꼭대기</span>
	        </button>
	        <button id="theme-detail">
	          <img src="./resources/image/farm.svg" alt="테마">
	          <span id="theme-name">농장</span>
	        </button>
	        <button id="theme-detail">
	          <img src="./resources/image/surfing.svg" alt="테마">
	          <span id="theme-name">서핑</span>
	        </button>
	        <button id="theme-detail">
	          <img src="./resources/image/cabin.svg" alt="테마">
	          <span id="theme-name">통나무집</span>
	        </button>
	        <button id="theme-detail">
	          <img src="./resources/image/countryside.png" alt="테마">
